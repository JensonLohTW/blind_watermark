...
wm_extract = bwm1.extract(embedded_path, wm_shape=len_wm, mode='bit')
...
att.cut_att(input_filename=embedded_path, output_file_name='output/截屏攻击.png', loc=loc)
...
recover_crop(template_file='output/截屏攻击1.png', output_file_name='output/截屏攻击1_还原.png',
             ...
             base_img=cv2.imread(embedded_path, cv2.IMREAD_COLOR))
...
# %%椒盐攻击
ratio = 0.05
att.salt_pepper_att(input_filename=embedded_path, output_file_name='output/椒盐攻击.png', ratio=ratio)
# ratio是椒盐概率
...
# %%旋转攻击
att.rot_att(input_filename=embedded_path, output_file_name='output/旋转攻击.png', angle=45)
...
# %%遮挡攻击
n = 60
att.shelter_att(input_filename=embedded_path, output_file_name='output/多遮挡攻击.png', ratio=0.1, n=n)
...
# %%缩放攻击
att.resize_att(input_filename=embedded_path, output_file_name='output/缩放攻击.png', out_shape=(800, 600))
